...
cur.execute(
    "CREATE TABLE IF NOT exists orders (id bigint primary key, order_state varchar not null , email varchar not null, name varchar not null, country varchar not null, state varchar, city varchar not null, street varchar not null, postal_code varchar not null, date TIMESTAMP not null, stripe_json text not null)"
)
cur.execute(
