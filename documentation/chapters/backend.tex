...
\end{itemize}
V případě prvního endpointu (/station/register) jde primárně o authorizaci stanice, aby data na server nemohl posílat neauthorizovaný uživatel. Tento POST požadavek očekává v parametru 
